...
<div class="max-w-2xl bg-white rounded-lg shadow p-6">
    <form method="POST" action="/dashboard/penetapan">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="tanggal_rencana_mulai" class="w-full px-4 py-2 border border-gray-300 rounded-lg">
        ...
        <div class="mb-6">
            ...
            <input type="date" name="tanggal_rencana_selesai" class="w-full px-4 py-2 border border-gray-300 rounded-lg">
