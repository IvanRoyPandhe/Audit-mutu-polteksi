...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
    ...
    <div class="bg-white rounded-2xl col-span-2 shadow-xl p-6 border border-gray-100 animate-fade-in-up" style="animation-delay: 0.6s;">
    ...
    <!-- Evaluasi Kesesuaian -->
    <div class="bg-white col-span-1 rounded-2xl shadow-xl p-6 border border-gray-100 animate-fade-in-up" style="animation-delay: 0.7s;">
