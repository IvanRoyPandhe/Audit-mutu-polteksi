...
<div class="mb-6 flex justify-between items-center">
    <h2 class="text-xl font-semibold">Daftar Formulir</h2>
    @if(auth()->user()->role_id == 1)
    <a href="/dashboard/buku-kebijakan/create/formulir" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">+ Tambah Formulir</a>
    @endif
</div>
